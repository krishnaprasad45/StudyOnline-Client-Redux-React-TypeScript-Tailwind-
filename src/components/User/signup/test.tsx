...
function Profile() {
  ...
  const handleImageUpload = async (
    ...
    try {
      const url = await uploadImage(image, foldername, (progress) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (previewMentorImage) {
        formData.append("image", previewMentorImage);
        await handleImageUpload(previewMentorImage as File, 'Mentor Image', setPreviewMentorImage);
      }
      if (previewAdhaarImage) {
        formData.append("aadhar_image", previewAdhaarImage);
        await handleImageUpload(previewAdhaarImage as File, 'Mentor Adhaar Image', setPreviewAdhaarImage);
      }
      if (previewExperienceImage) {
        formData.append("experience_image", previewExperienceImage);
        await handleImageUpload(previewExperienceImage as File, 'Mentor Exerience Image', setPreviewExperienceImage);
      }
                ...
                <input
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
                    ...
                    if (imageFileList && imageFileList.length > 0) {
                      ...
                      setPreviewMentorImage(undefined);
                      handleImageUpload(image, 'Mentor Image', setPreviewMentorImage);
                    }
                  }}
                  style={{ display: "none" }}
                />
              ...
              <label htmlFor="fileInput2" className="custom-file-upload">
                ...
                <input
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
                    ...
                    if (imageFileList && imageFileList.length > 0) {
                      const image = imageFileList[0];
                      setPreviewAdhaarImage(undefined);
                      handleImageUpload(image, 'Mentor Adhaar Image', setPreviewAdhaarImage);
                    }
                  }}
                  style={{ display: "none" }}
                />
              ...
              <div className="image-selection">
                ...
                <input
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
                    ...
                    if (imageFileList && imageFileList.length > 0) {
                      const image = imageFileList[0];
                      setPreviewExperienceImage(undefined);
                      handleImageUpload(image, 'Mentor Exerience Image', setPreviewExperienceImage);
                    }
                  }}
                  style={{ display: "none" }}
                />
